...
a persistence unit "EvaluacionWSChuchucaPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "EvaluacionWSChuchuca\pom.xml":
...
artifact ("EvaluacionWSChuchuca.war") is already built. You can build
